...
export const jobSummarySchema = z.object({
  ...
  worktree_base_ref: z.string().default(''),
  worktree_base_status: z.string().default(''),
  worktree_base_reason: z.string().default(''),
  worktree_origin_url: z.string().default(''),
  expected_origin_url: z.string().default(''),
  observed_git_branch: z.string().default(''),
  expected_git_branch: z.string().default(''),
  worktree_head_sha: z.string().default(''),
  canonical_base_sha: z.string().default(''),
  worktree_behind_by: z.number().int().nullable().default(null),
...
export const createSessionRequestSchema = z.object({
  ...
  approval_mode: z.enum(['ask', 'autonomous', 'trusted']).optional(),
