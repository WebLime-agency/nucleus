  ...
  <div class="grid gap-6 xl:grid-cols-[minmax(0,1.2fr)_minmax(320px,0.8fr)]">
    <Card>
      <CardHeader>
        ...
        <CardDescription>Enabled Skills can contribute include layers during compiled turn assembly.</CardDescription>
      </CardHeader>
            ...
            <div class="rounded-lg border border-zinc-800 bg-zinc-950/40 p-4">
              <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                <div class="min-w-0 space-y-2">
                  ...
                  <p class="text-sm text-zinc-300">{skill.description || 'No description yet.'}</p>
    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription>Create or update a workspace Skill manifest.</CardDescription>
      </CardHeader>
      <CardContent class="space-y-4">
        ...
        <div class="space-y-1"><Label for="skill-activation">Activation mode</Label><Input id="skill-activation" bind:value={form.activation_mode} /></div>
